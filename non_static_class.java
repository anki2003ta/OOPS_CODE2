...
public class non_static_class
{
    public static void main(String[] args)
    {
        ...
        obj1.accept();
        obj1.show();
        PersonDetails.ageCalculator obj=obj1.new ageCalculator();
        obj.agecalculate();
        obj1.date++;
